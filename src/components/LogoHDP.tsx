...
const LogoHDP = ({ color = "primary", className }: LogoHDPProps) => {
  const colors = {
    primary: "#36A765", // primary-500
    white: "#FFFFFF",
    black: "#000000",
  ...
  return (
    <img
      src={svgUrl}
      alt="Logo Hôtel de la plage Houlgate"
      className={className}
    />
  );
};

export default LogoHDP;
